...
public class CLIENT_WINDOW extends javax.swing.JFrame {
    ...
    public CLIENT_WINDOW() {
        ...
        /*
       populate the jtable with client data
        */
    ...
    private void jButton_Add_ClientActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Add_ClientActionPerformed
        ...
        //before inserting a new client we need to check the required data are empty
        ...
        {
            JOptionPane.showMessageDialog(null,"Enter The Required Client Information[first name, last name, phone,and address]","Add client",2);
        }
        else
        {
    ...
    private void jButton_Edit_ClientActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Edit_ClientActionPerformed
        ...
        try{
            ...
            //before edit the client data we need to check the required data are empty
            //required data-> first name, last name, phone,and address

            if( fname.trim().equals("") || lname.trim().equals("") || phone.trim().equals("") || address.trim().equals(""))
            {
                JOptionPane.showMessageDialog(null,"Enter The Required client Information[first name, last name, phone,and address]","Edit client",2);
            }
            else
            {
                if(client.editClientData(new P_CLIENT(ownerId, fname, lname, phone, email, address)))
                {
                    JOptionPane.showMessageDialog(null,"client Data Edit ","Edit client",1);
                }
                else
                {
                    JOptionPane.showMessageDialog(null,"client Data NOT Edit","Edit client",2);
                }
            }
        }catch(Exception ex)
        {
            JOptionPane.showMessageDialog(null,ex.getMessage()+"Enter a Vaild client ID ", "Invaild  Id",0);
        }
    ...
    private void jButton_Remove_ClientActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Remove_ClientActionPerformed
        ...
        try
        {
            ...
            else
            {
                ...
                int yes_or_on =JOptionPane.showConfirmDialog(null, "Do You Want To Delete This  client","Delete client",JOptionPane.YES_NO_OPTION);
                ...
                if(yes_or_on == JOptionPane.YES_OPTION)
                {
                    ...
                    {
                        JOptionPane.showMessageDialog(null,"Operation client ", "Delete client",2);
                    }
