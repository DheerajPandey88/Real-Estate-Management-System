...
public class PROPERTY_IMAGES_SLIDER extends javax.swing.JFrame {
    ...
    public PROPERTY_IMAGES_SLIDER(int pId) {
        ...
        //set border to the jlabel_image
        Border jlabel_image_border = BorderFactory.createMatteBorder(1, 1, 1, 1, Color.black);
        jLabel_Image.setBorder(jlabel_image_border);
        
        //set border to the next & previous jlabel
        Border jlabel_nav_border = BorderFactory.createMatteBorder(1, 1, 1, 1, Color.green);
    ...
    private void initComponents() {
        ...
        jLabel_Next.setMaximumSize(new java.awt.Dimension(26, 44));
        jLabel_Next.setMinimumSize(new java.awt.Dimension(26, 44));
        jLabel_Next.setOpaque(true);
        jLabel_Next.setPreferredSize(new java.awt.Dimension(26, 44));
        ...
        jLabel_Previous.setMaximumSize(new java.awt.Dimension(26, 44));
        jLabel_Previous.setMinimumSize(new java.awt.Dimension(26, 44));
        jLabel_Previous.setOpaque(true);
        jLabel_Previous.setPreferredSize(new java.awt.Dimension(26, 44));
        ...
        jLabel_Next.getAccessibleContext().setAccessibleName("          >");
    ...
    private void jLabel_PreviousMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel_PreviousMouseEntered
        jLabel_Previous.setBackground(color.green);
    ...
    private void jLabel_PreviousMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel_PreviousMouseExited
        ...
        jLabel_Previous.setForeground(color.blank);
    ...
    private void jLabel_NextMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel_NextMouseEntered
        jLabel_Next.setBackground(color.green);
    ...
    private void jLabel_NextMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel_NextMouseExited
        ...
        jLabel_Next.setForeground(color.blank);
