...
public class PROPERTY_TYPE_WINDOW extends javax.swing.JFrame {
    ...
    public PROPERTY_TYPE_WINDOW() {
        initComponents();
        //[153,153,153]light grey colour
         //set border to the jpanel title
        Border panel_title_border = BorderFactory.createMatteBorder(0, 0, 3, 0, Color.gray);
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(jButton_Refresh_Type, javax.swing.GroupLayout.PREFERRED_SIZE, 293, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jButton_Add_Type, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jButton_Edit_Type, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jButton_Remove_Type, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jButton_Refresh_Type, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(75, 75, 75))
        );
    ...
    private void jButton_Edit_TypeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Edit_TypeActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(null,ex.getMessage()+"Enter a Vaild Type ID ", "Invaild Id",0);
        }
    ...
    private void jButton_Remove_TypeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Remove_TypeActionPerformed
        ...
        try{
                ...
                { 
                    ...
                    int yes_or_on =JOptionPane.showConfirmDialog(null, "Do You Want To Delete This  Type","Delete Type",JOptionPane.YES_NO_OPTION);
                     ...
                     if(yes_or_on == JOptionPane.YES_OPTION)
                     {
                        if(type.execTypeQuery("remove", type))
                        {
                         ...
                         {
                                  JOptionPane.showMessageDialog(null,"Enter The Type Id ", "Empty Id",0);
                         }
        }catch(Exception ex)
        {
            JOptionPane.showMessageDialog(null,ex.getMessage()+"Enter a Vaild Type ID ", "Invaild Id",0);
